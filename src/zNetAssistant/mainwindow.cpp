    ...
    ui(new Ui::MainWindow)
{
    ...
    clearCounterButton->setText("counter clear");
...
void MainWindow::connectNet()
{
    ...
    isConnect = true;
    // 将状态设置为 通
    ui->state_label->setText("connect");
    QPalette pa;
...
void MainWindow::init()
{
    ...
    updateStateBar("localIP: " + chelper.getLocalHostIP().toString() + "  not connect",
                   QVariant(QVariant::Int), QVariant(QVariant::Int));
}
...
void MainWindow::disConnectNet()
{
    ...
    isConnect = false;
    // 将状态设置为 断
    ui->state_label->setText("dis connect");
    QPalette pa;
    pa.setColor(QPalette::WindowText,Qt::red);
    ui->state_label->setPalette(pa);
