...
typedef J_STATUS_TYPE (*tJ_Camera_Open)(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, uint32_t indexURL);
typedef J_STATUS_TYPE (*tJ_Camera_OpenMc)(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, DEVICE_ACCESS_FLAGS iOpenFlags, uint32_t iMcIP);
typedef J_STATUS_TYPE (*tJ_Camera_OpenEx)(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, DEVICE_ACCESS_FLAGS iOpenFlags, uint32_t iMcIP, uint32_t indexURL);
...
typedef J_STATUS_TYPE (*tJ_DataStream_FlushQueue)(STREAM_HANDLE hDS, ACQ_QUEUE_TYPE QueueType);
typedef J_STATUS_TYPE (*tJ_DataStream_StartAcquisition)(STREAM_HANDLE hDS, ACQ_START_FLAGS iFlags, uint64_t iNumImages);
typedef J_STATUS_TYPE (*tJ_DataStream_StopAcquisition)(STREAM_HANDLE hDS, ACQ_STOP_FLAGS iFlags);
typedef J_STATUS_TYPE (*tJ_DataStream_GetStreamInfo)(STREAM_HANDLE hDS, STREAM_INFO_CMD iCmd, void *pBuffer, uint32_t *pSize);
...
typedef J_STATUS_TYPE (*tJ_Event_GetInfo)(EVT_HANDLE pEventHandle, J_EVENT_INFO_CMD_TYPE iID, void *pBuffer, uint32_t *pSize);
...
typedef J_STATUS_TYPE (*tJ_Image_GetStreamInfo)(THRD_HANDLE hThread, STREAM_INFO_CMD iCmd, void *pBuffer, uint32_t *pSize);
...
typedef J_STATUS_TYPE (*tJ_Image_EnableParallelProcessing)(J_PARALLEL_PROCESSING processingMode);
...
typedef J_STATUS_TYPE (*tJ_Image_Get_PixelFormat)(CAM_HANDLE hCam, uint64_t nRemoteFormat, uint64_t *pJaiPixelFormat);
typedef J_STATUS_TYPE (*tJ_Image_Get_PixelFormatName)(CAM_HANDLE hCam, uint64_t nPixelFormat, int8_t* pJaiPixelFormatName, uint32_t size);
typedef J_STATUS_TYPE (*tJ_Camera_GetLocalDeviceHandle)(CAM_HANDLE hCam, DEV_HANDLE* hDevice);
typedef J_STATUS_TYPE (*tJ_Camera_GetInterfaceHandle)(CAM_HANDLE hCam, IF_HANDLE* hInterface);
typedef J_STATUS_TYPE (*tJ_Camera_GetTLHandle)(CAM_HANDLE hCam, TL_HANDLE* hTL);
typedef J_STATUS_TYPE (*tJ_Camera_GetTransportLayerName)(CAM_HANDLE hCam, int8_t* pBuffer, uint32_t* pSize);
typedef J_STATUS_TYPE (*tJ_GenTL_GetNumPortURLs)(PORT_HANDLE hCam, uint32_t* pNumURLs);

typedef J_STATUS_TYPE (*tJ_DataStream_GetBufferChunkData)(STREAM_HANDLE hDS, BUF_HANDLE hBuf, J_SINGLE_CHUNK_DATA *pChunkData, size_t *piNumChunks);
typedef J_STATUS_TYPE (*tJ_Camera_AttachChunkData)(CAM_HANDLE hCam, uint8_t* pBuffer, J_SINGLE_CHUNK_DATA *pChunkData, size_t iNumChunks);
typedef J_STATUS_TYPE (*tJ_Camera_UpdateChunkData)(CAM_HANDLE hCam, uint8_t* pBuffer);
typedef J_STATUS_TYPE (*tJ_Camera_DetachChunkData)(CAM_HANDLE hCam);
...
tJ_Camera_OpenEx                    pJ_Camera_OpenEx = 0;
...
tJ_Image_EnableParallelProcessing   pJ_Image_EnableParallelProcessing = 0;
...
tJ_Image_Get_PixelFormat			pJ_Image_Get_PixelFormat = 0; 
tJ_Image_Get_PixelFormatName		pJ_Image_Get_PixelFormatName = 0; 
tJ_Camera_GetLocalDeviceHandle		pJ_Camera_GetLocalDeviceHandle = 0; 
tJ_Camera_GetInterfaceHandle		pJ_Camera_GetInterfaceHandle = 0; 
tJ_Camera_GetTLHandle				pJ_Camera_GetTLHandle = 0; 
tJ_Camera_GetTransportLayerName		pJ_Camera_GetTransportLayerName = 0; 
tJ_GenTL_GetNumPortURLs				pJ_GenTL_GetNumPortURLs = 0; 

tJ_DataStream_GetBufferChunkData	pJ_DataStream_GetBufferChunkData = 0;
tJ_Camera_AttachChunkData			pJ_Camera_AttachChunkData = 0;
tJ_Camera_UpdateChunkData			pJ_Camera_UpdateChunkData = 0;
tJ_Camera_DetachChunkData			pJ_Camera_DetachChunkData = 0;

J_STATUS_TYPE OpenJaiSdk()
{
	...
	pJ_Camera_OpenEx                    = (tJ_Camera_OpenEx                )GetProcAddress(PUB_Handle, "J_Camera_OpenEx");
	...
	pJ_Image_EnableParallelProcessing   = (tJ_Image_EnableParallelProcessing       )GetProcAddress(PUB_Handle, "J_Image_EnableParallelProcessing");
	...
	pJ_Image_Get_PixelFormat			= (tJ_Image_Get_PixelFormat)		GetProcAddress(PUB_Handle, "J_Image_Get_PixelFormat");
	pJ_Image_Get_PixelFormatName		= (tJ_Image_Get_PixelFormatName)	GetProcAddress(PUB_Handle, "J_Image_Get_PixelFormatName");
	pJ_Camera_GetLocalDeviceHandle		= (tJ_Camera_GetLocalDeviceHandle)	GetProcAddress(PUB_Handle, "J_Camera_GetLocalDeviceHandle");
	pJ_Camera_GetInterfaceHandle		= (tJ_Camera_GetInterfaceHandle)	GetProcAddress(PUB_Handle, "J_Camera_GetInterfaceHandle");
	pJ_Camera_GetTLHandle				= (tJ_Camera_GetTLHandle)			GetProcAddress(PUB_Handle, "J_Camera_GetTLHandle");
	pJ_Camera_GetTransportLayerName		= (tJ_Camera_GetTransportLayerName)	GetProcAddress(PUB_Handle, "J_Camera_GetTransportLayerName");
	pJ_GenTL_GetNumPortURLs				= (tJ_GenTL_GetNumPortURLs)			GetProcAddress(PUB_Handle, "J_GenTL_GetNumPortURLs");

	pJ_DataStream_GetBufferChunkData    = (tJ_DataStream_GetBufferChunkData)GetProcAddress(PUB_Handle, "J_DataStream_GetBufferChunkData");
	pJ_Camera_AttachChunkData			= (tJ_Camera_AttachChunkData)		GetProcAddress(PUB_Handle, "J_Camera_AttachChunkData");
	pJ_Camera_UpdateChunkData			= (tJ_Camera_UpdateChunkData)		GetProcAddress(PUB_Handle, "J_Camera_UpdateChunkData");
	pJ_Camera_DetachChunkData			= (tJ_Camera_DetachChunkData)		GetProcAddress(PUB_Handle, "J_Camera_DetachChunkData");
	...
	if (!pJ_Factory_Open ||
		...
		!pJ_Image_EnableParallelProcessing || 
		...
		!pJ_Image_Get_PixelFormat || 	
		!pJ_Image_Get_PixelFormatName || 	
		!pJ_Camera_GetLocalDeviceHandle || 	
		!pJ_Camera_GetInterfaceHandle || 	
		!pJ_Camera_GetTLHandle || 	
		!pJ_Camera_GetTransportLayerName ||	
		!pJ_GenTL_GetNumPortURLs ||
		!pJ_DataStream_GetBufferChunkData ||
		!pJ_Camera_AttachChunkData ||
		!pJ_Camera_DetachChunkData ||
		!pJ_Camera_UpdateChunkData
		)
	{
		OutputDebugString(_T("GetProcAddress() failed\r\n"));
		FreeLibrary(PUB_Handle);
		return J_ST_INVALID_ADDRESS;
	}
...
J_STATUS_TYPE J_Factory_Open(const int8_t* psPrivateData, FACTORY_HANDLE *pHandle)
{
    ...
    return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Factory_Close(FACTORY_HANDLE hFac)
{
    J_STATUS_TYPE retsta = J_ST_ERR_NOT_INITIALIZED;
...
J_STATUS_TYPE J_Camera_Open(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, uint32_t indexURL)
{
    if (pJ_Camera_Open)
        return pJ_Camera_Open(hFac, pCameraID, hCam, indexURL);
    return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_OpenMc(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, DEVICE_ACCESS_FLAGS iOpenFlags, uint32_t iMcIP)
{
    if (pJ_Camera_OpenMc)
...
J_STATUS_TYPE J_Camera_OpenEx(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, DEVICE_ACCESS_FLAGS iOpenFlags, uint32_t iMcIP, uint32_t indexURL)
{
	if (pJ_Camera_OpenEx)
		return pJ_Camera_OpenEx(hFac, pCameraID, hCam, iOpenFlags, iMcIP, indexURL);
	return J_ST_ERR_NOT_IMPLEMENTED;
}
...
J_STATUS_TYPE J_DataStream_FlushQueue(STREAM_HANDLE hDS, ACQ_QUEUE_TYPE QueueType)
{
...
J_STATUS_TYPE J_DataStream_StartAcquisition(STREAM_HANDLE hDS, ACQ_START_FLAGS iFlags, uint64_t iNumImages)
{
...
J_STATUS_TYPE J_DataStream_StopAcquisition(STREAM_HANDLE hDS, ACQ_STOP_FLAGS iFlags)
{
...
J_STATUS_TYPE J_DataStream_GetStreamInfo(STREAM_HANDLE hDS, STREAM_INFO_CMD iCmd, void *pBuffer, uint32_t *pSize)
{
...
J_STATUS_TYPE J_Event_GetInfo(EVT_HANDLE pEventHandle, J_EVENT_INFO_CMD_TYPE iID, void *pBuffer, uint32_t *pSize)
{
    if (pJ_Event_GetInfo)
...
J_STATUS_TYPE J_Image_GetStreamInfo(THRD_HANDLE hThread, STREAM_INFO_CMD iCmd, void *pBuffer, uint32_t *pSize)
{
...
J_STATUS_TYPE J_Image_EnableParallelProcessing(J_PARALLEL_PROCESSING processingMode)
{
	if (pJ_Image_EnableParallelProcessing)
		return pJ_Image_EnableParallelProcessing(processingMode);
	return J_ST_ERR_NOT_IMPLEMENTED;
}
...
J_STATUS_TYPE J_Image_Get_PixelFormat(CAM_HANDLE hCam, uint64_t nRemoteFormat, uint64_t *pJaiPixelFormat)
{
	if (pJ_Image_Get_PixelFormat)
		return pJ_Image_Get_PixelFormat(hCam, nRemoteFormat, pJaiPixelFormat);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Image_Get_PixelFormatName(CAM_HANDLE hCam, uint64_t nPixelFormat, int8_t* pJaiPixelFormatName, uint32_t size)
{
	if (pJ_Image_Get_PixelFormatName)
		return pJ_Image_Get_PixelFormatName(hCam, nPixelFormat, pJaiPixelFormatName, size);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_GetLocalDeviceHandle(CAM_HANDLE hCam, DEV_HANDLE* hDevice)
{
	if (pJ_Camera_GetLocalDeviceHandle)
		return pJ_Camera_GetLocalDeviceHandle(hCam, hDevice);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_GetInterfaceHandle(CAM_HANDLE hCam, IF_HANDLE* hInterface)
{
	if (pJ_Camera_GetInterfaceHandle)
		return pJ_Camera_GetInterfaceHandle(hCam, hInterface);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_GetTLHandle(CAM_HANDLE hCam, TL_HANDLE* hTL)
{
	if (pJ_Camera_GetTLHandle)
		return pJ_Camera_GetTLHandle(hCam, hTL);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_GetTransportLayerName(CAM_HANDLE hCam, int8_t* pBuffer, uint32_t* pSize)
{
	if (pJ_Camera_GetTransportLayerName)
		return pJ_Camera_GetTransportLayerName(hCam, pBuffer, pSize);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_GenTL_GetNumPortURLs(PORT_HANDLE hCam, uint32_t* pNumURLs)
{
	if (pJ_GenTL_GetNumPortURLs)
		return pJ_GenTL_GetNumPortURLs(hCam, pNumURLs);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_DataStream_GetBufferChunkData(STREAM_HANDLE hDS, BUF_HANDLE hBuf, J_SINGLE_CHUNK_DATA *pChunkData, size_t *piNumChunks)
{
	if (pJ_DataStream_GetBufferChunkData)
		return pJ_DataStream_GetBufferChunkData(hDS, hBuf, pChunkData, piNumChunks);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_AttachChunkData(CAM_HANDLE hCam, uint8_t* pBuffer, J_SINGLE_CHUNK_DATA *pChunkData, size_t iNumChunks)
{
	if (pJ_Camera_AttachChunkData)
		return pJ_Camera_AttachChunkData(hCam, pBuffer, pChunkData, iNumChunks);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_UpdateChunkData(CAM_HANDLE hCam, uint8_t* pBuffer)
{
	if (pJ_Camera_UpdateChunkData)
		return pJ_Camera_UpdateChunkData(hCam, pBuffer);
	return J_ST_ERR_NOT_IMPLEMENTED;
}

J_STATUS_TYPE J_Camera_DetachChunkData(CAM_HANDLE hCam)
{
	if (pJ_Camera_DetachChunkData)
		return pJ_Camera_DetachChunkData(hCam);
	return J_ST_ERR_NOT_IMPLEMENTED;
}
