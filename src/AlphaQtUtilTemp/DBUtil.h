...
public:
     ...
     */
    static int insertReturnIntId(const QString &sql, const QVariantMap &params = QVariantMap());
	...
	* @return 
	*/
	static bool insert(const QString &sql, const QVariantMap &params = QVariantMap());
